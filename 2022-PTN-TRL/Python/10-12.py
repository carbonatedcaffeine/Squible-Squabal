...
#   Label(main_window, text="LOLOLOLOL") .grid(column=1,row=0)  #Deprecated test string
    Button(main_window, text="Quit",command=main_window.destroy, width=8) .place(x=0, y=0)
    Button(main_window, text="Append list", width=14, height=6) .place(x=345,y=0)
    ...
    Label(main_window, text="Quantity of item")# .place(x=,y=75)
